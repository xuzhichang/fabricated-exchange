...
The mod is currently in beta. It is targetting 1.20.1. Once it is in a stable, feature complete state, 
I will port it to older versions that are popular for modding. Afterwards it will be upgraded to whatever versions after 1.20.1 that are most popular for mods.
